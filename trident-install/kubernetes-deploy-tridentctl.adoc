...
[%collapsible]
====
Pour plus d'informations sur le détachement forcé, reportez-vous à link:..trident-get-started/kubernetes-customize-deploy.html["Personnalisez l'installation de l'opérateur Trident"]la section .
