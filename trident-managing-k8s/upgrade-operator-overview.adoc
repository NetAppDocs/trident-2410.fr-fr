...
TIP: Pour plus d'informations sur l'architecture Astra Trident sur le cluster Kubernetes, veuillez vous référer à link:../trident-get-started/intro.html#astra-trident-architecture["Architecture d'Astra Trident"].
