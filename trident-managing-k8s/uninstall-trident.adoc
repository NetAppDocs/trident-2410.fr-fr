...
* Si vous rencontrez des problèmes suite à une mise à jour, des problèmes de dépendances ou une mise à jour incomplète ou ayant échoué, vous devez désinstaller Astra Trident et réinstaller la version précédente en suivant les instructions spécifiques à cette version. Il s'agit de la seule méthode recommandée pour _downgrader_ vers une version antérieure.
