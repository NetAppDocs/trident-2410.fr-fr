...
| `luksEncryption` | Activez le chiffrement LUKS. Consultez link:../trident-reco/security-luks.html["Utiliser la configuration de clé unifiée Linux (LUKS)"]. SAN uniquement. | « » 
