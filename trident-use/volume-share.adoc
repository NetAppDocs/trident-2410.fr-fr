...
À l'aide de l'[`tridentctl`utilitaire, vous pouvez exécuter la commande  `get`pour obtenir les volumes subordonnés. Pour plus d'informations, consultez le lien : ../trident-managing-k8s/tridentctl.html[`tridentctl` commandes et options].
