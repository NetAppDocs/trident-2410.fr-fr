...
summary: 'Trident permet aux utilisateurs de Kubernetes d"étendre leurs volumes après leur création. Trouvez des informations sur les configurations requises pour développer les volumes iSCSI et NFS.' 
---
...
NOTE: L'extension de volume iSCSI est prise en charge par les `ontap-san` `solidfire-san` pilotes , `ontap-san-economy` et requiert Kubernetes 1.16 et versions ultérieures.
