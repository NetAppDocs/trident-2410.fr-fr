...
NOTE: Pour connaître le calendrier de prise en charge de la dernière version de Trident, veuillez vous référer au https://docs.netapp.com/us-en/trident/get-help.html#trident-support-lifecycle["Page du cycle de vie du support"^].
